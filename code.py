...
def rotation2matrix(rotation):
    """Convierte un vector de rotación en una matriz de rotación"""
    return Rotation.from_rotvec(rotation).as_matrix()
